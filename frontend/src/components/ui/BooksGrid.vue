<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <RegisteredBestsellerView @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></RegisteredBestsellerView>
            <RegisteredBookView @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></RegisteredBookView>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Books 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Books 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
