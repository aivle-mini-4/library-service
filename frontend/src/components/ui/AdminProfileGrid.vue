<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <AdminPage @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></AdminPage>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">AdminProfile 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">AdminProfile 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
